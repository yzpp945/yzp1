						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${productList.pages}" var="pageNum">
									<c:if test="${pageNum==productList.pageNum}">
								<li class="active"><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&size=${productList.pageSize}">${pageNum}</a></li>
									</c:if>
									<c:if test="${pageNum!=productList.pageNum}">
